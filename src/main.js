...
class WeatherService {
	constructor(apiKey) {
		...
		this.forecastData = 'https://api.openweathermap.org/data/2.5/onecall?lat=26.45&lon=74.6333&exclude=minutely,hourly,alerts&appid=999b8b7890bf53144128ad433541e05c&units=imperial';
		this.units = 'imperial';
...
const OPENWEATHER_KEY = '999b8b7890bf53144128ad433541e05c';
